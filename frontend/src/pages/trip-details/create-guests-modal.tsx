...
export function CreateGuestsModal({ closeCreateGuestsModal }: CreateGuestsModalProps) {
    ...
    async function createGuests(event: FormEvent<HTMLFormElement>) {
        ...
        function errorNotification() {
            toast.error("Erro ao adicionar convidado! Verifique os dados e tente novamente.");
        }
